    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.policy-and-tos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.policyAndTo.fields.privacy_policy_helper') }}</span>
            </div>
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.policyAndTo.fields.tos_helper') }}</span>
            </div>
            <div class="form-group">
          ...
          return loader.file
            .then(function (file) {
              return new Promise(function(resolve, reject) {
                ...
                data.append('crud_id', '{{ $policyAndTo->id ?? 0 }}');
                xhr.send(data);
              });
            })
        }
