    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.templates.update", [$template->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('template_fields') ? 'is-invalid' : '' }}" name="template_fields" id="template_fields" required>{{ old('template_fields', json_decode(json_encode($template->template_fields))) }}</textarea>
